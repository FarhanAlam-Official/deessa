          ...
          <ScrollReveal animation="scale-in" delay={200}>
            <div className="flex justify-center">
              <div className="relative w-72 h-72">
                ...
                {/* Inner circle */}
                <div className="absolute inset-16 rounded-full bg-primary/10 border border-primary/40 backdrop-blur-sm flex items-center justify-center">
                  <Podcast className="size-16 text-primary" />
                </div>
                {/* Waveform bars */}
